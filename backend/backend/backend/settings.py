...
SECRET_KEY = 'django-insecure-+058mi92gszp40ntg$$&adt29pgo*rc%ves0u*@0la4b2w_68k'
...
# Custom User Model
AUTH_USER_MODEL = 'inventario.UserRol'  # Asegúrate de que apunte a tu modelo de usuario personalizado


# Configura CORS
CORS_ORIGIN_ALLOW_ALL = True  # Permite todas las solicitudes (solo para desarrollo)
